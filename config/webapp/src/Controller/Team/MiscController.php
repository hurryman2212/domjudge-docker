...
class MiscController extends BaseController
{
    ...
    public function homeAction(Request $request): Response
    {
        ...
        $submissionSort = $request->query->get('submission_order') === 'problem' ? 'problem' : 'time';
        ...
        $data = [
            ...
            'refresh' => [
                'after' => 30,
                'url' => $this->generateUrl('team_index', ['submission_order' => $submissionSort]),
                'ajax' => true,
            ],
        ...
        if ($contest) {
            ...
            $data = array_merge(
                ...
                $this->scoreboardService->getScoreboardTwigData(
                    $request, null, $data['refresh']['url'], true, false, false,
                    $contest, $scoreboard
                )
            );
